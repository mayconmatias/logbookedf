...
DECLARE
  v_user_id uuid := auth.uid();
BEGIN
  -- 1. Fecha treinos antigos que têm séries (Salva o progresso)
  -- Define o 'ended_at' como o horário da última série realizada naquele treino
  ...
  -- 2. Remove treinos antigos VAZIOS (Lixo)
  -- Se não tem séries, não tem valor histórico, então apagamos.
